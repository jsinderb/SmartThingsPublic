...
metadata {
	definition(name: "Github Multi Sensor", namespace: "smartthings", author: "SmartThings") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name: "status", type: "generic", width: 1, height: 1) {
			tileAttribute("device.status", key: "PRIMARY_CONTROL") {
				attributeState "open", label: 'Open', icon: "st.contact.contact.open", backgroundColor: "#cccccc"
		...
		standardTile("contact", "device.contact", width: 1, height: 1) {
			state("open", label: 'Open', icon: "st.contact.contact.open", backgroundColor: "#808080")
			state("closed", label: 'Closed', icon: "st.contact.contact.closed", backgroundColor: "#808080")
		}
		standardTile("acceleration", "device.acceleration", width: 6, height: 4) {
			state("active", label: 'Active', icon: "st.motion.acceleration.active", backgroundColor: "#e86d13")
			state("inactive", label: 'Inactive', icon: "st.motion.acceleration.inactive", backgroundColor: "#808080")
		}
		...
		main(["acceleration", "temperature"])
		details(["acceleration", "temperature", "battery", "refresh"])
	}
}
